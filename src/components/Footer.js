          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <p className="text-gray-400 mb-6 max-w-md">
                Passionate software developer and engineering student building intelligent solutions 
                through code, innovation, and engineering. Always learning, always growing.
              </p>
                ...
                <div className="flex space-x-3">
                  {socialLinks.map((social, index) => (
                    <motion.a
                      ...
                      whileTap={{ scale: 0.95 }}
                      className="p-2 rounded-lg bg-gray-800 hover:bg-gray-700 text-gray-400 hover:text-white transition-all duration-300 hover:shadow-glow"
            ...
            >
              ...
              <div className="space-y-3 text-gray-400">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm">yakkantiguruvardhan@gmail.com</span>
                </div>
                <div className="flex items-center space-x-2">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  <span className="text-sm">+91 9502712026</span>
                </div>
                <div className="flex items-center space-x-2">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-sm">Tirupati, AP, India</span>
                </div>
                <div className="flex items-center space-x-2">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="mt-6">
                <a
                  ...
                  className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white text-sm font-medium rounded-lg transition-all duration-300 hover:shadow-glow"
                >
                  Let's Work Together
                </a>
              </div>
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            >
              <p>
                © {currentYear} Guruvardhan Yakkanti. All rights reserved. | 
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.1 }}
              whileTap={{ scale: 0.95 }}
              className="flex items-center space-x-2 px-4 py-2 bg-gray-800 hover:bg-gray-700 text-gray-400 hover:text-white rounded-lg transition-all duration-300 text-sm"
